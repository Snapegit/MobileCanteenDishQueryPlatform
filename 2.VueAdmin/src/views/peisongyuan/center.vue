				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="配送员账号" prop="peisongyuanzhanghao">
							<el-input class="list_inp" v-model="user.peisongyuanzhanghao" readonly placeholder="配送员账号" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="配送员姓名" prop="peisongyuanxingming">
							<el-input class="list_inp" v-model="user.peisongyuanxingming"  placeholder="配送员姓名" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="peisongyuantouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="性别" prop="xingbie">
							<el-select 
								...
								placeholder="请选择性别"
								>
								<el-option v-for="item in peisongyuanxingbieLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="12">
...
<script setup>
	...
	const tableName = ref('peisongyuan')
	const user = ref({})
	const peisongyuanxingbieLists = ref([])
	const init = () => {
		peisongyuanxingbieLists.value = "男,女".split(',')
	}
	const peisongyuantouxiangUploadSuccess=(fileUrls)=> {
	    user.value.touxiang = fileUrls;
	}
	const onSubmit = () => {
		if((!user.value.peisongyuanzhanghao)){
			context?.$toolUtil.message(`配送员账号不能为空`,'error')
			return false
		}
		if((!user.value.mima)){
		...
		if((!user.value.peisongyuanxingming)){
			context?.$toolUtil.message(`配送员姓名不能为空`,'error')
			return false
		}
