	...
	<div>
		<div class="register_view">
			<el-form :model="registerForm" class="register_form">
				...
				<div class="list_item">
					<div class="list_label">配送员账号：</div>
					<el-input class="list_inp"
						 v-model="registerForm.peisongyuanzhanghao" 
						 placeholder="请输入配送员账号"
						 type="text"
						/>
				</div>
				<div class="list_item">
				...
				<div class="list_item">
					<div class="list_label">配送员姓名：</div>
					<el-input class="list_inp"
						 v-model="registerForm.peisongyuanxingming" 
...
<script setup>
	...
	const handleRegister = () => {
		...
		if((!registerForm.value.peisongyuanzhanghao)){
		...
		if((!registerForm.value.peisongyuanxingming)){
