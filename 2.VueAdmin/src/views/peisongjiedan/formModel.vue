				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="收货人" prop="shouhuoren">
							<el-input class="list_inp" v-model="form.shouhuoren" placeholder="收货人"
								 type="text" 								:readonly="!isAdd||disabledForm.shouhuoren?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="配送员账号" prop="peisongyuanzhanghao">
							<el-input class="list_inp" v-model="form.peisongyuanzhanghao" placeholder="配送员账号"
								 type="text" 								:readonly="!isAdd||disabledForm.peisongyuanzhanghao?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="配送员姓名" prop="peisongyuanxingming">
							<el-input class="list_inp" v-model="form.peisongyuanxingming" placeholder="配送员姓名"
								 type="text" 								:readonly="!isAdd||disabledForm.peisongyuanxingming?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='shouhuoren'){
					form.value.shouhuoren = row[x];
					disabledForm.value.shouhuoren = true;
					continue;
				}
				if(x=='dizhi'){
				...
				if(x=='peisongyuanzhanghao'){
					form.value.peisongyuanzhanghao = row[x];
					disabledForm.value.peisongyuanzhanghao = true;
					continue;
				}
				if(x=='peisongyuanxingming'){
					form.value.peisongyuanxingming = row[x];
					disabledForm.value.peisongyuanxingming = true;
					continue;
				}
				if(x=='lianxidianhua'){
		...
		context?.$http({
			...
			if(json.hasOwnProperty('peisongyuanzhanghao')&& context?.$toolUtil.storageGet("role")!="管理员"){
				form.value.peisongyuanzhanghao = json.peisongyuanzhanghao
				disabledForm.value.peisongyuanzhanghao = true;
			}
			if(json.hasOwnProperty('peisongyuanxingming')&& context?.$toolUtil.storageGet("role")!="管理员"){
				form.value.peisongyuanxingming = json.peisongyuanxingming
				disabledForm.value.peisongyuanxingming = true;
			}
		...
		peisongzhuangtaiLists.value = "已完成,配送中".split(',')
	}
	//初始化
	//声明父级调用
	defineExpose({
